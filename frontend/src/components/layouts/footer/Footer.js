    ...
    return (
        <section className="footer-container">
            <div className="container">
                <h2>If you have any queries feel free to contact.</h2>
                ...
                <form onSubmit={handleSubmit} ref={form} className="footer-form">
                    ...
                    <div className="form-groupss">
                       <button> <input type="submit" value="Submit" className="form-submit" /></button>
                    </div>
                </form>

                <p>&copy; StuBooks. All Rights Reserved.</p>
            </div>
        </section>
    )
}
